...
# Modifications copyright 2017 Eric Trant and Tein van der Lugt
#
...
def read_data(dataset_path, max_size=None):
    ...
    with open(dataset_path, "r") as f:
        ...
        while input_sentence and output_sentence:
            ...
            input_chars = data_utils.sentence_to_token_ids(input_sentence)
            output_chars = data_utils.sentence_to_token_ids(output_sentence)
            output_chars.append(data_utils.EOS_ID)
