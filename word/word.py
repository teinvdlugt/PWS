...
def read_data(dialogue_path, max_size=None):
    ...
    with tf.gfile.GFile(dialogue_path, mode="r") as dialogue_file:
            input_sentence = dialogue_file.readline()
            output_sentence = dialogue_file.readline()
            counter = 0
            while input_sentence and output_sentence and (not max_size or counter < max_size):
                counter += 1
                if counter % 100000 == 0:
